  ...
  return (
    <main className="min-h-screen flex items-start justify-center py-16 px-6">
      <div className="w-full max-w-lg">
        <Link href="/" className="text-xs text-[#555] hover:text-[#e8392a] flex items-center gap-2 mb-10 tracking-widest uppercase transition-colors">
        ...
        <p className="text-[#555] text-sm mb-8">Your input helps us build a better product.</p>
