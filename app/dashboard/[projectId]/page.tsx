    ...
    <main className="min-h-screen py-12 px-6">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex items-start justify-between flex-wrap gap-4">
          <div>
            <Link href="/dashboard" className="text-xs text-[#999] hover:text-[#e8392a] flex items-center gap-2 mb-3 tracking-widest uppercase transition-colors">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-white uppercase tracking-tight break-all">{project?.name ?? "—"}</h1>
            ...
            <button
              ...
              className={`px-5 py-3 text-xs font-bold tracking-widest uppercase border-b-2 -mb-px transition-colors ${
                tab === t
                  ...
                  : "border-transparent text-[#777] hover:text-[#888]"
              }`}
            >
        ...
        {tab === "responses" && (
          <div className="space-y-4">
            ...
            <div className="border border-[#1e1e1e] bg-[#0d0d0d] p-6">
              {loading ? (
                <div className="flex items-center justify-center py-16 text-[#777]">
